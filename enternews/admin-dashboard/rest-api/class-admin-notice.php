...
class AdminNotice
{
  ...
  function enternews_dashboard_notice_content()
  {
    ...
    $notice_header = sprintf(
      ...
      esc_html__('👋 Welcome, and Thank You!', 'enternews'),
      sprintf(
        esc_html__('%s is now active. We\'re here to help you turn your ideas into a beautiful, professional website — quickly and confidently.', 'enternews'),
        $this->theme_name
      )
    );
    ...
    $notice_external_msg = sprintf(
      ...
      __('🤝 We\'re Here for You', 'enternews'),
      esc_html__('Whether you\'re just starting or customizing your site.', 'enternews'),
      esc_html__('Documentation', 'enternews'),
      esc_html__('Videos', 'enternews'),
      esc_html__('Support', 'enternews'),
