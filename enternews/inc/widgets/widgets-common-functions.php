...
if (!function_exists('enternews_get_excerpt')):
    function enternews_get_excerpt($length = 25, $enternews_content = null, $post_id = 1) {
        ...
        $enternews_default_excerpt = get_the_excerpt($post_id);


        $enternews_global_excerpt_length = $length;
        $excerpt = explode(' ', $enternews_default_excerpt, $enternews_global_excerpt_length);
        if (count($excerpt)>=$enternews_global_excerpt_length) {
            array_pop($excerpt);
        ...
        //$excerpt = $excerpt.$enternews_read_more;
        return $excerpt;
    }
endif;
