      ...
      if ($post_categories) {
        ...
        foreach ($post_categories as $post_category) {
          ...
          $output .= '<li class="meta-category">
                             <a class="enternews-categories ' . esc_attr($color_class) . '"aria-label="' . esc_attr($post_category->name) . '" href="' . esc_url(get_category_link($post_category)) . '" alt="' . esc_attr(sprintf(__('View all posts in %s', 'enternews'), $post_category->name)) . '"> 
